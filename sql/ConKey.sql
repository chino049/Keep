create or replace function	nc_drop_all_check_constraints()
returns	integer
as
'
	----------------------------------------------------------------------
	...
	begin
		--------------------------------------------------------------
		--	Drop the Check Constraints one by one.
		--------------------------------------------------------------
		for l_record in
			select		t.relname,
					c.conname
...
select nc_drop_all_check_constraints();        
select nc_drop_all_fkeys();

drop function	nc_drop_all_check_constraints();
